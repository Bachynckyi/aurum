      ...
      <div className={scss.container}>
            <div className={scss.content_wrapper}>
              ...
              <div className={scss.list_wrapper}>
                  <a href={"/assets/Anthroposophy_in_the_WHO_system.pdf"} rel="noopener noreferrer" target="_blank" className={scss.button_download}>
                      <MdOutlineScreenSearchDesktop className={scss.icon}/>
                      <span className={scss.button_download_text}>{t("Medicine_presentation1")}</span>
                  </a>
                  <a href={"/assets/Homeopathy_in_the_WHO_system.pdf"} rel="noopener noreferrer" target="_blank" className={scss.button_download}>
                      <MdOutlineScreenSearchDesktop className={scss.icon}/>
                      <span className={scss.button_download_text}>{t("Medicine_presentation2")}</span>
                  </a>
                  <a href={"/assets/WHO_Report_2019.pdf"} rel="noopener noreferrer" target="_blank" className={scss.button_download}>
                      <MdOutlineScreenSearchDesktop className={scss.icon}/>
                      <span className={scss.button_download_text}>{t("Medicine_presentation3")}</span>
                  </a>
                  <a href={"/assets/About_Anthroposophical_Medicine.pdf"} rel="noopener noreferrer" target="_blank" className={scss.button_download}>
                      <MdOutlineScreenSearchDesktop className={scss.icon}/>
                      <span className={scss.button_download_text}>{t("Medicine_presentation4")}</span>
                  </a>
                  <a href={"https://iris.who.int/discover?query=anthroposophic+medicine"} rel="noopener noreferrer" target="_blank" className={scss.button_download}>
